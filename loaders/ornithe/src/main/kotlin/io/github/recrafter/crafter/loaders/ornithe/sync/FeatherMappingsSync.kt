package io.github.recrafter.crafter.loaders.ornithe.sync
...
object FeatherMappingsSync : MappingsSync(ModLoaderType.ORNITHE) {

    override val mavenUrl: Url =
        buildUrl("maven.ornithemc.net") {
            path("releases", "net", "ornithemc", "feather-gen2", MavenMetadata.FILE_NAME)
        }
