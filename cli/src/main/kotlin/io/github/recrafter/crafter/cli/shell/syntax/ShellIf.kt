...
class ShellIf internal constructor(
    ...
    val booleanOperator: ShellLogicalOperator,
    val body: String,
) {
    ...
    companion object {
        fun ofIf(
            ...
            booleanOperator: ShellLogicalOperator,
        ...
        fun ofIf(condition: String, builder: ShellScriptBuilder.() -> ShellScriptBuilder): ShellIf =
            ShellIf(listOf(condition), ShellLogicalOperator.AND, shellScript(builder))

        fun ofElse(builder: ShellScriptBuilder.() -> ShellScriptBuilder): ShellIf =
            ofIf(emptyList(), ShellLogicalOperator.AND, builder)
    }
}
