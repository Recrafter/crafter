...
abstract class InstallCrafterCLITask : DefaultTask() {
    ...
    private fun generateCompletionScript(fingerprint: Fingerprint): String = script {
        ...
        run_(BashCompletion.COMPLETE_COMMAND, spaced("-F", crafterCompleteFunction, CrafterConstants.PLUGIN_LOWER_NAME))
        ifBlock {
            if_(bash.isZsh()) {
    ...
    companion object {
        ...
        private fun ScriptBuilder.disclaimer(fingerprint: Fingerprint, scriptType: ScriptType): ScriptBuilder {
            comment(
                "This ${scriptType.getName()} script was generated by the " +
                        "${CrafterConstants.PLUGIN_NAME} Gradle Plugin."
            )
        ...
        private fun buildFingerprint(modMetadata: ModMetadata): Fingerprint =
            Fingerprint(
                pluginVersion = modMetadata.pluginVersion,
                ...
                modNamespace = modMetadata.namespace,
                ...
                loaders = ModLoaderType.entries.map { loader ->
                    Fingerprint.LoaderInfo(
                        ...
                        checkpoints = LoaderCompatibility.getCheckpoints(loader),
                    )
                },
            )
